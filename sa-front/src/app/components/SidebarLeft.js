...
export default function SidebarLeft() {
    return (
        <div className="flex flex-no-wrap">
            <div className="w-64 absolute sm:relative bg-gray-800 shadow h-full flex-col justify-between flex">
                <div className="px-8">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="/" class="flex items-center p-2 text-base font-normal text-gray-500 rounded-lg transition duration-75 dark:text-white hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700">
                                <ion-icon class="w-6 h-6" name="home-outline"></ion-icon>
                                <span class="ml-3">Home</span>
                            </a>
                        </li>
                        <li>
                            <a href="Turnos" class="flex items-center p-2 text-base font-normal text-gray-500 rounded-lg transition duration-75 dark:text-white hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700">
                                <ion-icon class="w-6 h-6" name="heart"></ion-icon>
                                <span class="flex-1 ml-3 whitespace-nowrap">Turnos</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-2 text-base font-normal text-gray-500 rounded-lg transition duration-75 dark:text-white hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700">
                            <ion-icon class="w-6 h-6" name="body-outline"></ion-icon>
                            <span class="flex-1 ml-3 whitespace-nowrap">Ejercicios</span>
                    ...
                    <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700">
                        <li>
                            <a href="#" class="flex items-center p-2 text-base font-normal text-gray-500 rounded-lg transition duration-75 hover:bg-gray-300 hover:text-black dark:hover:bg-gray-700 dark:text-white group">
                ...
                <div className="px-8 mt-48 border-t border-gray-700">
